            ...
            <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                <div class="container"><a class="navbar-brand" href="#">Company Name</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse"
                        ...
                        </form><span class="navbar-text"> <a href="views/auth/login.php" class="login">Log In</a></span><a class="btn btn-light action-button" role="button" href="views/auth/registre.php">Sign Up</a></div>
                </div>
            </nav>
            <div class="container hero">
                <div class="row">
                    ...
                    <div
                        ...
                        <div class="iphone-mockup"><img src="public/images/biblio2.jpg" class="device">
